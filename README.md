...
- верстка страниц по макету Figma
- реализация адаптивности для различных экранов
- разработка стилей и структуры страниц
- работа с интерактивность сайта с помощью JavaScript
...
- работы с базовыми методами JavaScript DOM
